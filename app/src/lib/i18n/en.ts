...
export default {
  ...
  settings: {
    theme: {
      ...
      customHint: "Drop a .ghostty file into the agent's ~/.pocketshell/themes/ and it shows up here",
      delete: "Delete theme",
      ...
      skip: {
        name: "{file}: unusable file name (letters, digits, dash and underscore only)",
      ...
      importName: "Theme name (letters, digits, - and _)",
      ...
      importErr: {
        name: "Unusable theme name: letters, digits, dash and underscore only",
