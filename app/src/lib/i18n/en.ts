...
`,
  ...
  git: {
    ...
    loadMore: "Load more",
    review: {
      entryAll: "Review all changes",
      entryRange: "This branch vs {base}",
      entryFiles: "{n} files",
      back: "Back",
      titleWorktree: "All changes",
      subtitleWorktree: "Working tree",
      subtitleRange: "Branch comparison",
      summaryFiles: "{n} files",
      segAll: "All",
      segStaged: "Staged",
      segUnstaged: "Unstaged",
      baselineLabel: "Base",
      ...
      oversizeHint: "{n} changed lines — view it in the terminal",
      binary: "Binary file",
      deleted: "File deleted",
      newdir: "New directory",
      newdirHint: "Not expanded — view it in the terminal or file panel",
      folded: "Large change, collapsed",
      foldedHint: "Tap the filename above to expand",
      emptyBody: "No text changes",
      end: "End of list — {n} files",
      noChanges: "No changes",
      truncatedNote: "Some files were too large to load",
      loadingSlow: "Loading a large diff…",
      retry: "Retry",
      badRevision: "Commit not found",
      noBaseline: "Could not determine a base branch — please pick one",
    },
  },
  preview: {
    noChanges: "No changes",
